...
export const MOCK_PROJECTS: InfrastructureProject[] = [
  {
    ...
    leadAgency: 'National Highways Authority of India (NHAI)',
    states: ['Gujarat', 'Maharashtra'],
    statesInvolved: ['Gujarat', 'Maharashtra'],
    totalLengthKm: 378,
  ...
  },
  {
    ...
    leadAgency: 'Dedicated Freight Corridor Corporation of India (DFCCIL)',
    states: ['Maharashtra'],
    statesInvolved: ['Maharashtra'],
    totalLengthKm: 135,
  ...
  },
  {
    ...
    leadAgency: 'National High Speed Rail Corp (NHSRCL)',
    states: ['Maharashtra', 'Gujarat', 'Dadra & Nagar Haveli'],
    statesInvolved: ['Maharashtra', 'Gujarat', 'Dadra & Nagar Haveli'],
    totalLengthKm: 508,
  ...
  },
  {
    ...
    ministry: 'Jal Shakti',
    type: 'River Interlinking',
    executingAgency: 'National Water Development Agency (NWDA)',
    leadAgency: 'National Water Development Agency (NWDA)',
    states: ['Madhya Pradesh', 'Uttar Pradesh'],
    statesInvolved: ['Madhya Pradesh', 'Uttar Pradesh'],
    totalLengthKm: 221,
  ...
  },
  {
    ...
    leadAgency: 'NHAI PIU-Vellore & Bengaluru',
    states: ['Karnataka', 'Andhra Pradesh', 'Tamil Nadu'],
    statesInvolved: ['Karnataka', 'Andhra Pradesh', 'Tamil Nadu'],
    totalLengthKm: 262,
